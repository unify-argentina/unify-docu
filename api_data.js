define({ "api": [
  ...
  {
    "type": "post",
    "url": "/api/user/:user_id/email/:email_id/seen",
    ...
    "filename": "api/email/index.js",
    "groupTitle": "Email",
    "name": "PostApiUserUser_idEmailEmail_idSeen",
    "sampleRequest": [
      {
        "url": "http://localhost:8080/api/user/:user_id/email/:email_id/seen"
      }
    ]
  },
  {
  ...
  },
  {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "email_id",
            "description": "<p>Id del email a marcar como no leído</p> "
          }
        ]
      }
    },
    ...
    "filename": "api/email/index.js",
    "groupTitle": "Email",
    "name": "PostApiUserUser_idEmailEmail_idUnseen",
    "sampleRequest": [
      {
