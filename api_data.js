define({ "api": [
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://localhost:8080/api/user/:user_id/email/seen"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://localhost:8080/api/user/:user_id/email/unseen"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://localhost:8080/api/user/:user_id/email/untrash"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://localhost:8080/api/user/:user_id/password"
      }
    ]
  }
] });